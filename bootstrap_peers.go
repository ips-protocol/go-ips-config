...
// for IPWS. they are nodes run by the IPWS team. docs on these later.
// As with all p2p networks, bootstrap is an important security concern.
//
// NOTE: This is here -- and not inside cmd/ipws/init.go -- because of an
...
var DefaultBootstrapAddresses = []string{
	...
	// IPWeb Storage Bootstrap Peers
	// "/ip4/47.90.246.175/tcp/4001/ipfs/QmamEgmvzTLvfvhDepXSgfaFQcbnihSo7ASakfqmJMTXtq",  // demo net
	// "/ip4/180.97.144.190/tcp/4001/ipfs/QmWb9ra6trs9HpXp4dRH1WPucV7Xin3cG3AD4Dswp4sEmk", // test net
	"/ip4/180.97.144.181/tcp/4001/ipfs/QmQ2TDEhdkzv2d81AnzwYn1JA6HJkZCKuWGv5dzXevXd9b", // main net
}
...
// This is here (and not inside cmd/ipws/init) because of module dependency problems.
func DefaultBootstrapPeers() ([]BootstrapPeer, error) {
	ps, err := ParseBootstrapPeers(DefaultBootstrapAddresses)
	if err != nil {
		return nil, fmt.Errorf(`failed to parse hardcoded bootstrap peers: %s
This is a problem with the ipws codebase. Please report it to the dev team.`, err)
	}
	return ps, nil
}
